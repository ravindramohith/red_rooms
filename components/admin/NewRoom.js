...
import { newRoomAdmin, clearErrors } from '../../redux/actions/roomActions'
import { NEW_ROOM_ADMIN_RESET } from '../../redux/constants/roomConstants'
...
const NewRoom = () => {
    ...
    useEffect(() => {
        ...
        if (success) {
            ...
            dispatch({ type: NEW_ROOM_ADMIN_RESET })
        }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(newRoomAdmin(roomData))
    ...
    const onChange = (e) => {
        ...
        if (size > 1000000) {
            toast.error('total Images size must not exceed 1MB limit')
        }
    }
