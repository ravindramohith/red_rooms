...
import { getroomReviewsAdmin, clearErrors, deleteReviewAdmin } from '../../redux/actions/roomActions'
import { DELETE_REVIEW_ADMIN_RESET } from '../../redux/constants/roomConstants'
...
const RoomReviews = () => {
    ...
    useEffect(() => {
        ...
        if (isDeleted) {
            toast.success('Review is deleted uccessfully')
    ...
    const deleteReviewHandler = (id) => {
        dispatch(deleteReviewAdmin(roomId, id));
    }
