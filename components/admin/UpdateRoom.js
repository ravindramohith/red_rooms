...
import { updateRoomAdmin, getRoom, clearErrors } from '../../redux/actions/roomActions'
import { UPDATE_ROOM_ADMIN_RESET } from '../../redux/constants/roomConstants'
...
const UpdateRoom = () => {
    ...
    useEffect(() => {
        ...
        if (isUpdated) {
            ...
            dispatch({ type: UPDATE_ROOM_ADMIN_RESET })
        }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updateRoomAdmin(room._id, roomData))
